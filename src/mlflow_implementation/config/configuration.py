...
class ConfigFileManagement:
    def __init__(self, param_filepath=PARAMS_FILE_PATH, config_filepath=CONFIG_FILE_PATH):
        """
        Initialize ConfigFileManagement class.

        :param param_filepath: Filepath for parameters.
        :param config_filepath: Filepath for configuration.
        """
    ...
    def get_data_creation_config(self) -> DataCreationConfig:
        """
        Retrieve DataCreationConfig from parameters.

        :return: DataCreationConfig object.
        """
    ...
    def get_data_preprocessing_config(self) -> DataPreprocessingConfig:
        """
        Retrieve DataPreprocessingConfig from parameters.

        :return: DataPreprocessingConfig object.
        """
    ...
    def get_model_training_config(self) -> ModelTrainingConfig:
        """
        Retrieve ModelTrainingConfig from parameters.

        :return: ModelTrainingConfig object.
        """
